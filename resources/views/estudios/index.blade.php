    ...
    <div class="container mt-4">
        ...
        <form method="GET" action="{{ route('estudios.index') }}" class="mb-4">
            <div class="input-group">
                <input type="text" name="search" value="{{ $search }}" class="form-control" placeholder="Buscar por nombres, apellidos o empresa">
        ...
        <table class="table">
            <thead>
                <tr>
                    ...
                    <th style="width: 15%;">Fecha de Carga</th>
        ...
        {{ $estudios->appends(['search' => $search])->links() }}
    </div>
</x-app-layout>
